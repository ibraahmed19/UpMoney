...
import { TransactionComponent } from './modules/admin/dashboards/transaction/transaction.component';
import { CreditComponent } from './modules/admin/dashboards/credit/credit.component';
import { InsuranceComponent } from './modules/admin/dashboards/insurance/insurance.component';
import { BankingAccountComponent } from './modules/admin/dashboards/banking-account/banking-account.component';
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'dashboards', children: [
                {path: 'transaction',loadChildren: () => import('app/modules/admin/dashboards/transaction/transaction.module').then(m => m.TransactionModule)},
                {path: 'credit', loadChildren: () => import('app/modules/admin/dashboards/credit/credit.module').then(m => m.CreditModule)},
                {path: 'insurance', loadChildren: () => import('app/modules/admin/dashboards/insurance/insurance.module').then(m => m.InsuranceModule)},
                {path: 'bankingAccount', loadChildren: () => import('app/modules/admin/dashboards/transaction/transaction.module').then(m => m.TransactionModule)},
