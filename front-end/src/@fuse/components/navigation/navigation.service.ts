...
export class FuseNavigationService
{
     ...
     */
    getFlatNavigation(navigation: FuseNavigationItem[] | undefined, flatNavigation: FuseNavigationItem[] = []): FuseNavigationItem[] {
     ...
     * @param navigation
     */
    getItem(id: string, navigation: FuseNavigationItem[] | null): FuseNavigationItem | null {
        if (!navigation || !Array.isArray(navigation)) {
          return null;
        }
